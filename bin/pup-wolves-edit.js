...
(function() {
  ...
  tacoCommand = (function(_super) {
    ...
    tacoCommand.prototype.randomTaco = function() {
      var r, tacos;
      tacos = ["Mexican Pizza", "Chicken Soft Taco", "Double Decker Taco", "Volcano Taco Supreme", "Crunchy Taco Supreme", "Grilled Steak Soft Taco", "Cheesy Gordita Crunch", "Doritos Locos Taco","Fish Taco","Crunch Wrap Supreme"];
  ...
  newSongsCommand = (function(_super) {
    ...
    newSongsCommand.prototype.functionality = function() {
      ...
      } else if (u.indexOf("wolvespls") !== -1) {
        selections['channels'].push('wolvespls');
      } else {
    ...
    newSongsCommand.prototype.memberChannels = ["JitterStep", "MistaDubstep", "DubStationPromotions", "UndergroundDubstep", "JesusDied4Dubstep", "DarkstepWarrior", "BombshockDubstep", "Sharestep", "wolvespls"];
